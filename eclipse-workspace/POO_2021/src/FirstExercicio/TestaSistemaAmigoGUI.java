...
public class TestaSistemaAmigoGUI{
	...
	public static void main(String [] args){
		...
		//TODO
		SistemaAmigo sistema = new SistemaAmigo(quantMaxMensagens);		
		boolean sair = false;
		while(!sair) {
			...
			switch(opcao) {
				...
				case(2):
					...
					break;
				case(3):
					for(Amigo a: sistema.resultadoSorteio()){
						System.out.println("O amigo secreto de "+ a.getEmail() +" é " +a.getEmailAmigoSorteado());
					}
					break;
				case(4):
					sair = true;
